...
<html>
<head>
	<title>| Sistema Admin ingolar |</title>
...
BODY {
  ...
  <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
    ...
    <tr>
      <td width="200" rowspan="2" align="left" valign="top" bgcolor="#9F9C97"> <uc1:UCNavigation id="UserControl1" runat="server"></uc1:UCNavigation></td>
...
<tr>
            ...
            <form id="Form1" runat="server">
                ...
                <td width="202" height="20" align="left" valign="middle">
                          <ASP:RequiredFieldValidator id="chkUserID" runat="server" errormessage="Es necesario ingresar un User ID" width="132px" controltovalidate="txtUserID" display="Dynamic"></ASP:RequiredFieldValidator></td>
                        </tr>
                        <tr>
                ...
                <td width="202" height="20" align="left" valign="middle">
                          <ASP:RequiredFieldValidator id="chkPassword" runat="server" errormessage="Es necesario ingresar un Password" controltovalidate="txtPassword" display="Dynamic"></ASP:RequiredFieldValidator></td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td height="20" colspan="2" align="right"  valign="middle">
                              <ASP:Button CssClass="boton_formulario" id="btnLogin" runat="server" 
                                  text="INGRESAR" width="86px" onclick="btnLogin_Click" BackColor="#666666"></ASP:Button></td>
                        </tr>
                      </table>
    ...
    <tr>
      <td width="200" height="30" bgcolor="#768984">&nbsp;</td>
      <td width="10" bgcolor="#768984">&nbsp;</td>
      <td width="770" bgcolor="#768984">&nbsp;</td>
      <td width="20" bgcolor="#768984">&nbsp;</td>
    </tr>
  </table>
    </div>
</body>
