...
<table width="200" border="0" cellspacing="1" cellpadding="0" style="background-color: #9F9C97">
    <tr>
    ...
    <tr id="divLogin" runat="server">
      ...
      <td height="20" bgcolor="#7B838A"><asp:HyperLink CssClass="izq" ID="lnkCRM" NavigateUrl="Login.aspx" runat="server">CRM Login</asp:HyperLink></td>
      <td height="20">&nbsp;</td>
    </tr>
    ...
    <tr id="divlnkHome">
      <td height="20">&nbsp;</td>
      <td bgcolor="#d2d2c6">&nbsp;</td>
      <td height="20" bgcolor="#7B838A"><ASP:HyperLink CssClass="izq" id="lnkHome"
    ...
    <tr id="divlblVentas" >
      ...
      <td height="20" bgcolor="#7B838A" class="titleBlanco" style="HEIGHT: 21px">
        <ASP:Label id="lblVentas" runat="server">Ventas:</ASP:Label></td>
      <td height="20" style="HEIGHT: 21px">&nbsp;</td>
    </tr>
    <tr id="divlnkAddVenta" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="#303030">&nbsp;</td>
      <td height="20" bgcolor="#7B838A">&nbsp;&nbsp;&nbsp;&nbsp;<ASP:HyperLink id="lnkAddVenta" runat="server" cssclass="izq2" navigateurl="AddVenta.aspx">Nueva Venta</ASP:HyperLink></td>
      <td height="20">&nbsp;</td>
    </tr>
    <tr id="divlnkListVentas" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="#303030">&nbsp;</td>
      <td height="20" bgcolor="#7B838A">&nbsp;&nbsp;&nbsp;&nbsp;<ASP:HyperLink
    ...
    <tr id="divlblProductos" >
      ...
      <td height="20" bgcolor="#7B838A" class="titleBlanco">
    ...
    <tr id="divlnkChangePassword" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="#d2d2c6">&nbsp;</td>
      <td height="20" bgcolor="#7B838A" classname="izq"><ASP:HyperLink id="lnkChangePassword" class="izq"
    ...
    <tr id="divlnkLogout" >
      ...
      <td height="20" bgcolor="#7B838A" style="HEIGHT: 20px">
        <p>
          <ASP:HyperLink id="lnkLogout" runat="server" cssclass="izq2" navigateurl="LogOut.aspx">Log Out</ASP:HyperLink>
        </p></td>
      <td width="10" height="20" style="HEIGHT: 20px">&nbsp;</td>
    </tr>
    <tr style="background:gray" runat="server" id="trTipoSitio" visible="false">
      <td width="10">&nbsp;</td>
      <td width="4">&nbsp;</td>
      <td>TESTING...</td>
      <td width="10">&nbsp;</td>
